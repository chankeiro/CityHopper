...
namespace Bercetech.Games.Fleepas
{
    public class ObjectPool : MonoBehaviour
    {
        ...
        private static ObjectPool _sharedInstace;
        public static ObjectPool SharedInstace => _sharedInstace;
        ...
        public int CountPooledActiveObjectsByName(string objectName)
        {
            return _pooledObjects.Where(t => t.name == objectName + "(Clone)" & t.activeInHierarchy).Count();
        }
    }
}