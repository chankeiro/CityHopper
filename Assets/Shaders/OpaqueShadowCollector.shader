...
Shader "Custom/OpaqueShadowCollector"
{
    Properties
    {
        ...
        SubShader
    {
        ...
        // Geometry+1 makes the shader render the texture after regular geometry, masked geometry and
        ...
        Tags { "LightMode" = "ForwardBase" "RenderType" = "Transparent" "Queue" = "Geometry-10" "ForceNoShadowCasting" = "True"  }
        LOD 100
        ZWrite Off
